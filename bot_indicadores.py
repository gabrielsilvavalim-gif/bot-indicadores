...
INDICADORES = {
    "Faturamento": {"tipo": "simples", "categoria": "faturamento", "TIPO": "ECONOMICO", "GRUPO 01": "FATURAMENTO", "GRUPO 02": None, "GRUPO 03": None, "TIPO DE META": "R$"},
    "Faturamento Serviços": {"tipo": "simples", "categoria": "faturamento", "TIPO": "ECONOMICO", "GRUPO 01": "FATURAMENTO", "GRUPO 02": "SERVICOS", "GRUPO 03": None, "TIPO DE META": "R$"},
    "Faturamento Regular": {"tipo": "simples", "categoria": "faturamento", "TIPO": "ECONOMICO", "GRUPO 01": "FATURAMENTO", "GRUPO 02": "SERVICOS", "GRUPO 03": "REGULAR", "TIPO DE META": "R$"},
    "Faturamento Incremental": {"tipo": "simples", "categoria": "faturamento", "TIPO": "ECONOMICO", "GRUPO 01": "FATURAMENTO", "GRUPO 02": "SERVICOS", "GRUPO 03": "INCREMENTAL", "TIPO DE META": "R$"},
    "Faturamento LCSAO": {"tipo": "simples", "categoria": "faturamento", "TIPO": "ECONOMICO", "GRUPO 01": "FATURAMENTO", "GRUPO 02": "SERVICOS", "GRUPO 03": "LCSAO", "TIPO DE META": "R$"},
    "Faturamento Sucata Diversa": {"tipo": "simples", "categoria": "faturamento", "TIPO": "ECONOMICO", "GRUPO 01": "FATURAMENTO", "GRUPO 02": "SUCATAS DIVERSAS", "GRUPO 03": None, "TIPO DE META": "R$"},
    "Faturamento Reman Rev": {"tipo": "simples", "categoria": "faturamento", "TIPO": "ECONOMICO", "GRUPO 01": "FATURAMENTO", "GRUPO 02": "REMAN REV", "GRUPO 03": None, "TIPO DE META": "R$"},
    "Faturamento Reman Cap": {"tipo": "simples", "categoria": "faturamento", "TIPO": "ECONOMICO", "GRUPO 01": "FATURAMENTO", "GRUPO 02": "REMAN CAP", "GRUPO 03": None, "TIPO DE META": "R$"},
    "Faturamento Reman Total": {"tipo": "composto", "componentes": ["Faturamento Reman Rev", "Faturamento Reman Cap"]},
    "Faturamento Pneus Velhos": {"tipo": "simples", "categoria": "faturamento", "TIPO": "ECONOMICO", "GRUPO 01": "FATURAMENTO", "GRUPO 02": "PNEUS VELHOS", "GRUPO 03": QUALQUER, "TIPO DE META": "R$"},
    "Faturamento Pneu Exceto Moto": {"tipo": "simples", "categoria": "faturamento", "TIPO": "ECONOMICO", "GRUPO 01": "FATURAMENTO", "GRUPO 02": "PNEUS VELHOS", "GRUPO 03": None, "TIPO DE META": "R$"},
    "Faturamento Especial": {"tipo": "simples", "categoria": "faturamento", "TIPO": "ECONOMICO", "GRUPO 01": "FATURAMENTO", "GRUPO 02": "ESPECIAL", "GRUPO 03": None, "TIPO DE META": "R$"},
    "Despesa Geral": {"tipo": "simples", "categoria": "despesa", "TIPO": "ECONOMICO", "GRUPO 01": "DESPESAS", "GRUPO 02": None, "GRUPO 03": QUALQUER, "TIPO DE META": "%"},
    "Despesa Manutenção": {"tipo": "simples", "categoria": "despesa", "TIPO": "ECONOMICO", "GRUPO 01": "DESPESAS", "GRUPO 02": "MANUTENCAO", "GRUPO 03": QUALQUER, "TIPO DE META": "R$"},
    "Despesa Hora Extra": {"tipo": "simples", "categoria": "despesa", "TIPO": "ECONOMICO", "GRUPO 01": "DESPESAS", "GRUPO 02": "HORAS EXTRAS", "GRUPO 03": QUALQUER, "TIPO DE META": "R$"},
}

FILIAIS_REAIS = ["CANOAS/RS", "CURITIBA/PR", "DUQUE DE CAXIAS/RJ", "VALINHOS/SP"]
MESES_MAPA = {1: "Jan", 2: "Fev", 3: "Mar", 4: "Abr", 5: "Mai", 6: "Jun", 7: "Jul", 8: "Ago", 9: "Set", 10: "Out", 11: "Nov", 12: "Dez"}
...
def tabela_completa_ano(d, ano, indicador):
    ...
    for i in range(1, 13):
        ...
        if len(sub) > 0:
            ...
            rows.append({"Mês": mes_nome, "Realizado": real, "Meta": meta, "Gap (R$)": gap, "Atingimento": ating})
        else:
            rows.append({"Mês": mes_nome, "Realizado": None, "Meta": None, "Gap (R$)": None, "Atingimento": None})
    ...
    rows.append({"Mês": "TOTAL", "Realizado": total_real, "Meta": total_meta, "Gap (R$)": total_gap, "Atingimento": total_ating})
...
def calcular_mom(d, indicador):
    ...
    return base.rename(columns={"MÊS_NOME": "Mês", "REALIZADO_CALC": "Realizado", "META_CALC": "META"})[["ANO", "MÊS", "Mês", "META", "Realizado", "Ating.", "MoM_%", "MÊS_ORDEM"]]
...
def comparar_mesmo_periodo(d, indicador, ano_referencia=None):
    ...
    return pd.DataFrame([
        {"Ano": ano_anterior, "Período": periodo_txt, "Realizado": real_ant, "Meta": meta_ant, "Gap (R$)": gap_ant, "Atingimento": ating_ant, "Variação Realizado": None, "Variação Meta": None},
        {"Ano": ano_referencia, "Período": periodo_txt, "Realizado": real_atual, "Meta": meta_atual, "Gap (R$)": gap_atual, "Atingimento": ating_atual, "Variação Realizado": var_real, "Variação Meta": var_meta},
    ])
...
class PDFRelatorio(FPDF):
    ...
    def header(self):
        ...
        self.fonte("", 10)
        self.cell(0, 6, self.safe(f"Indicador: {self.indicador} | Filial: {self.filial}"), align="C", new_x="LMARGIN", new_y="NEXT")
    ...
    def tabela_mom(self, df_mom):
        self.fonte("B", 10)
        self.set_fill_color(240, 240, 240)
        headers = ["Mes", "Meta", "Realizado", "Gap", "Ating."]
        ...
        for _, row in df_mom.iterrows():
            ...
            self.cell(widths[4], 7, fmt_pct(row["Ating."]), border=1, align="R")
            self.ln()
    ...
    def tabela_periodo(self, df_periodo):
        self.fonte("B", 10)
        self.set_fill_color(240, 240, 240)
        headers = ["Ano", "Periodo", "Realizado", "Meta", "Gap", "Ating.", "Var. Real."]
        ...
        for _, row in df_periodo.iterrows():
            ...
            self.cell(widths[6], 7, fmt_pct(var_real) if pd.notna(var_real) else "-", border=1, align="R")
            self.ln()
...
def gerar_pdf(df, df_todas, indicador, filial, ano_selecionado):
    ...
    pdf.tabela_mom(df_mom[df_mom["ANO"] == ano_selecionado][["Mês", "META", "Realizado", "Gap", "Ating."]])
    ...
    if filial == "Geral":
        ...
        pdf.tabela_filiais(comparativo_filiais(df_todas, ano_selecionado, indicador))
...
with st.sidebar:
    ...
    st.divider()
    st.caption("v4.2 — Bot Indicadores")
...
tab0, tab1, tab2, tab3, tab4 = st.tabs(["📊 Dashboard", "📅 Por Ano", "📈 MoM", "🔁 YoY", "🤖 Insights IA"])
...
with tab0:
    ...
    c1.metric("Realizado Ano", fmt_brl(realizado_total))
    c2.metric("Meta Ano", fmt_brl(meta_total))
    c3.metric("Gap Ano", fmt_brl(gap_total))
    c4.metric("Atingimento da meta", fmt_pct(ating_total))
    c5.metric(
        f"YTD {periodo_label}",
